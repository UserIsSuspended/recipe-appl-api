...
class CommandTests(SimpleTestCase):
    ...
    def test_wait_for_db_delay(self, patched_sleep, patched_check):
        ...
        # the first 2 times of running this mocked function Psycopg2Error
        # will be raised
        # from times 3 to 5 django OperationalError will be raised in this mock
        # the 6th time it returns True
        # backslash is the syntax to break it into 2 lines so it might look:
        # pathced_check.side_effect = [Psycopg2Error] * 2 +
        # [OperationalError] * 3 + [True](last 2  comms are 1 line)
