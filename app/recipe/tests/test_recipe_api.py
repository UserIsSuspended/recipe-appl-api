...
def create_recipe(user, **params):
    """Create and returb a sample recipe"""
    defaults = {
...
class PublicRecipeAPITests(TestCase):
    ...
    def test_auth_required(self):
        """Test auth is required to call an API."""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_update_user_returns_error(self):
        """Test changing the reci[e user returns error."""
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        indian_tags = Tag.objects.filter(name='Indian')
        self.assertEqual(Tag.objects.all().count(), 2)
        self.assertEqual(indian_tags.count(), 1)
        for tag in payload['tags']:
            exists = recipe.tags.filter(
                name=tag['name'],
                user=self.user,
    ...
    def test_create_tag_on_update(self):
        ...
        self.assertNotIn('Lunch', recipe.tags.all())
    ...
    def test_update_recipe_assigning_tag(self):
